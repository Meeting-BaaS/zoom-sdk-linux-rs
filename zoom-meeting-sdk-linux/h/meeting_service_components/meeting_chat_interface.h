...
struct InsertLinkAttrs {
    ...
    const zchar_t* insertLinkUrl = nullptr; 
};
...
struct ParagraphAttrs {
    ...
    const zchar_t* strParagraph = nullptr; 
};
...
{
	/**
	 * The ut value depends on the value of the other members in the structure. 
