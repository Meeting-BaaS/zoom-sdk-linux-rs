...
public:
     ...
     * @param bMute Pre-set audio mute or unmute status.
     * @return SDKERR_SUCCESS means the pre-set success, otherwise failed.
     */
	 ...
	 * @param bMute Pre-set video mute or unmute status.
	 * @return SDKERR_SUCCESS means the pre-set success, otherwise failed.
	 */
